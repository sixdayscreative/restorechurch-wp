 ...
 */
function restoreproject_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function restoreproject_hide_if_no_cats( $field ) {
 ...
 */
function restoreproject_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function restoreproject_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function restoreproject_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'restoreproject_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function restoreproject_register_demo_metabox() {
	$prefix = 'restoreproject_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'restoreproject_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'restoreproject_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'restoreproject_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'restoreproject_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'restoreproject_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'restoreproject_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'restoreproject_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function restoreproject_register_about_page_metabox() {
	$prefix = 'restoreproject_about_';
...
add_action( 'cmb2_admin_init', 'restoreproject_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function restoreproject_register_repeatable_group_field_metabox() {
	$prefix = 'restoreproject_group_';
...
add_action( 'cmb2_admin_init', 'restoreproject_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function restoreproject_register_user_profile_metabox() {
	$prefix = 'restoreproject_user_';
...
add_action( 'cmb2_admin_init', 'restoreproject_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function restoreproject_register_taxonomy_metabox() {
	$prefix = 'restoreproject_term_';
...
add_action( 'cmb2_admin_init', 'restoreproject_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function restoreproject_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'restoreproject_theme_options_page',
		...
		'option_key'      => 'restoreproject_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'      => 'restoreproject_options_page_message_callback',
	) );
 ...
 * }
 */
function restoreproject_options_page_message_callback( $cmb, $args ) {
...
add_action( 'cmb2_init', 'restoreproject_register_rest_api_box' );
/**
 ...
 */
function restoreproject_register_rest_api_box() {
	$prefix = 'restoreproject_rest_';
